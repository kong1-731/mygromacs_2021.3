...
// Check whether we do sinusoidal pressure control
bool doSinP(const t_inputrec* ir);

// Initialize sinusoidal pressure control
bool initSinP(t_inputrec* ir, gmx::Update* upd);

// Alter the inputrec by setting new sinP targets
void update_sinP_target_press(t_inputrec* ir, real t, gmx::Update* upd);

// Calculate whether or not it is the update refP time within sinusoidal pressure
